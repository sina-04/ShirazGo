...
The MIT License applies to original ShirazGo source code and repository
documentation authored by Sina Rezaei.

It does not grant rights to:

- `assets/shiraz-subway-timetable.pdf` or
  `assets/shiraz-subway-timetable-fa.pdf`;
- official or reconstructed metro schedule data;
